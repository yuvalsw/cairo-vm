...
use super::builtin_hint_processor::builtin_hint_processor_definition::{
    HintProcessorData, ProgramContext,
};
use crate::Felt252;
...
pub trait HintProcessorLogic {
    ...
    fn execute_hint_extensive(
        ...
        self.execute_hint(vm, exec_scopes, program_context, hint_data, constants)?;
